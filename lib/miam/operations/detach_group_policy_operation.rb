module Miam
  module Operations
    class DetachGroupPolicyOperation < Operation
      ...
      FAILURE_MESSAGE = \
        'Unable to detach policy, group/policy does not exists or ' \
      ...
      def call(args)
        ...
        Output.new(
          group_name: group_name, policy_name: policy_name, detached: true
        )
